...
/** Friday / Firebase client bucket — use Firebase Storage REST, not raw GCS JSON API. */
export const STORAGE_BUCKET = 'noteclaude-a5b3b.firebasestorage.app';
/** Legacy App Engine-style name — search for older objects; GCS JSON may 404 both. */
export const STORAGE_BUCKET_LEGACY = 'noteclaude-a5b3b.appspot.com';
