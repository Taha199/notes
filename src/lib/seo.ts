...
const PAGE_META: Partial<Record<Page, { sv: { title: string; description: string }; en: { title: string; description: string }; noindex?: boolean }>> = {
  ...
  quizDashboard: {
    sv: { title: 'Quizstatus – Taha Note', description: 'Se vilka quiz du inte börjat, börjat eller klarat.' },
    en: { title: 'Quiz status – Taha Note', description: 'See which quizzes you have not started, started, or finished.' },
  },
  arabicKb: {
