...
export const LANGS: Record<Lang, Translation> = {
  en: {
    ...
    filesLoadFailed: 'Could not load your files. Check your connection and try again.', filesRetry: 'Try again', filesUploadStuck: 'Upload blocked (browser could not reach storage). Try again, or use Safari / another browser.',
  ...
  sv: {
    ...
    filesLoadFailed: 'Kunde inte hämta dina filer. Kontrollera anslutningen och försök igen.', filesRetry: 'Försök igen', filesUploadStuck: 'Uppladdningen blockerades (webbläsaren nådde inte lagringen). Försök igen, eller använd Safari / en annan webbläsare.',
