...
export const LANGS: Record<Lang, Translation> = {
  en: {
    ...
    navLibrary: 'Notes Library', navFiles: 'File Uploads', navQuizDashboard: 'Quiz Panel', navArabicKb: 'Arabic keyboard', navCountdown: 'Countdown', navQuizStats: 'Statistics', navArchive: 'Archive', navTrash: 'Trash',
    ...
    pageFav: 'Favourites', pageTodo: 'To-do calendar', pageArch: 'Archive', pageFiles: 'File Uploads', pageQuizDashboard: 'Quiz Panel', pageArabicKb: 'Arabic keyboard', pageCountdown: 'Countdown', pageQuizStats: 'Quiz statistics', pageTrash: 'Trash',
    ...
    settingsCloudBackupEmpty: 'No internal backups yet. A safety snapshot is saved automatically about every minute while you use the app.',
    ...
    settingsCloudBackupHint: 'Internal safety copies inside Firebase (for undo after accidents). Saved about every minute, last 48 kept. Use “Backup outside Firebase” for a copy you control.',
    ...
    quizOverviewToday: 'Questions created today',
    quizOverviewLast12Months: 'Last 12 months',
    quizDashTitle: 'Quiz Panel',
  ...
  sv: {
    ...
    navLibrary: 'Anteckningsbibliotek', navFiles: 'Ladda upp filer', navQuizDashboard: 'Quiz Panel', navArabicKb: 'Arabiskt tangentbord', navCountdown: 'Nedräkning', navQuizStats: 'Statistik', navArchive: 'Arkiv', navTrash: 'Papperskorg',
    ...
    pageFav: 'Favoriter', pageTodo: 'Att göra', pageArch: 'Arkiv', pageFiles: 'Ladda upp filer', pageQuizDashboard: 'Quiz Panel', pageArabicKb: 'Arabiskt tangentbord', pageCountdown: 'Nedräkning', pageQuizStats: 'Quizstatistik', pageTrash: 'Papperskorg',
    ...
    filesEmpty: 'Inga filer uppladdade ännu', filesDownload: 'Ladda ner', filesDownloading: 'Laddar ner… {n}%', filesPreview: 'Förhandsgranska', filesRename: 'Byt namn', filesRenameSuccess: 'Filnamn uppdaterat', filesPreviewUnavailable: 'الملف غير مدعوم — Förhandsgranskning finns inte för den här filtypen.', filesPreviewFailed: 'Kunde inte ladda förhandsgranskningen. Du kan fortfarande ladda ner filen.', filesDownloadFailed: 'Kunde inte ladda ner filen. Försök igen.', filesMissingInStorage: 'Filen saknas i molnlagringen. Radera den och ladda upp igen.', filesDelete: 'Radera', filesStored: 'Sparad i molnet',
    ...
    settingsCloudBackupEmpty: 'Inga interna säkerhetskopior ännu. En säkerhetskopia sparas automatiskt ungefär varje minut medan du använder appen.',
    ...
    settingsCloudBackupHint: 'Interna säkerhetskopior i Firebase (för ångra efter olyckor). Sparas ungefär varje minut, senaste 48 behålls. Använd “Backup utanför Firebase” för en kopia du kontrollerar.',
    ...
    quizOverviewToday: 'Antal frågor skapade idag',
    ...
    noteClose: '✕ Stäng',
    notePaste: '📋 Klistra in anteckning',
