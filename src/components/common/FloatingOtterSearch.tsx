  ...
  return createPortal(
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className={
          'otter-launcher fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full border border-white/60 bg-white shadow-xl shadow-primary/25 dark:border-white/10 dark:bg-gray-900 sm:bottom-6 ' +
