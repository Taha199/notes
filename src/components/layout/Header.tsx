...
const ICONS: Record<Page, string> = {
  home: '🏠', fav: '★', todo: '📅', unread: '📖', read: '✓', library: '📚', files: '📎', arabicKb: '⌨️', countdown: '⏳', quizOverview: '📈', quizStats: '📊', archive: '🗄', trash: '🗑', quiz: '🧠', download: '💻', settings: '⚙️', admin: '👑',
};
