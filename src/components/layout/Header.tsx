...
import { HeaderCountdownWidget } from '../countdown/HeaderCountdownWidget';
import { LanguageSwitcher } from '../common/LanguageSwitcher';
import { useArabicInput } from '../../contexts/ArabicInputContext';
import { normalizeSearch } from '../../lib/noteSearch';

const ICONS: Record<Page, string> = {
  home: '🏠', fav: '★', todo: '📅', unread: '📖', read: '✓', library: '📚', files: '📎', quizDashboard: '🗂', arabicKb: '⌨️', countdown: '⏳', quizStats: '📊', archive: '🗄', trash: '🗑', quiz: '🧠', download: '💻', settings: '⚙️', admin: '👑',
};
...
export const Header = memo(function Header({
  ...
  const titles: Record<Page, string> = {
    home: t.pageHome, fav: t.pageFav, todo: t.pageTodo, unread: t.pageUnread, read: t.pageRead, library: t.pageLib, files: t.pageFiles, quizDashboard: t.pageQuizDashboard, arabicKb: t.pageArabicKb, countdown: t.pageCountdown, quizStats: t.pageQuizStats, archive: t.pageArch, trash: t.pageTrash, quiz: 'Quiz', download: t.pageDownload, settings: t.settingsTitle, admin: t.adminTitle,
  };
  ...
  return (
    <div className="flex min-h-[62px] flex-shrink-0 flex-col gap-3 border-b border-app-border bg-white px-3 py-3 dark:border-white/10 dark:bg-gray-900 sm:px-5 md:flex-row md:items-center md:justify-between">
      <div className="flex min-w-0 items-center gap-2.5">
        ...
        <HeaderCountdownWidget className="hidden sm:inline-flex" onOpen={onOpenCountdown} />
      </div>
