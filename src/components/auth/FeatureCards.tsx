    ...
    <div className={'flex w-full max-w-[420px] flex-col gap-3 ' + (align === 'center' ? 'mx-auto' : '')}>
      {cards.map((c, i) => {
        ...
        return (
          <div
            key={i}
            className="animate-slide-up flex items-center gap-4 rounded-2xl border border-white/60 bg-white/60 px-5 py-4 text-left backdrop-blur-md shadow-sm transition-all hover:-translate-y-0.5 hover:bg-white/80 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
